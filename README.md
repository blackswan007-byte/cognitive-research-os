...
| :--- | :--- | :--- |
| Reflection | The Analytical Engine critiques its own initial findings before forming a conclusion.
| Tool Use | The *Data Inquisitor is mandated to execute Python code for statistical validation.
| Persona-Based | Each agent adopts a distinct cognitive stance (Skeptic, Polymath, Auditor).
| Chain-of-Thought | The *Narrative Curator relies on the step-by-step logic logs generated by previous agents.
